...
class Player(pygame.sprite.Sprite):
    def __init__(self, groups, obstacles):
        ...
        self.speed = 200
        self.obstacles = obstacles #collision_sprites group is an attribute of the player, the player is not in the group
    ...
    def collision(self, direction):
        collision_sprites = pygame.sprite.spritecollide(self, self.obstacles, False) #pygame method
        print(collision_sprites)
        if collision_sprites:
            if direction == 'horizontal':
                for sprite in collision_sprites:
                    # collision on the right
                    if self.rect.right >= sprite.rect.left and self.old_rect.right <= sprite.old_rect.left: #you need both conditionals to check. the first isn't suffice
...
class Ball(pygame.sprite.Sprite):
    ...
    def update(self, dt):
        self.old_rect = self.rect.copy() #every frame update you make a copy of the rectangle position and put it into old_rect
...
# sprite setup
StaticObstacle((100,300),(100,50),[all_sprites,collision_sprites]) #position, size, groups
...
while True:
    ...
    for sprite in all_sprites: #draw an organge rectangle underneath all of the sprites
